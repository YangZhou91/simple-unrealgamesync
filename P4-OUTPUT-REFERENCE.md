...
示例中的项目、路径和素材名称均为虚构值。计数用于说明输出解析。
...
| 行尾标志 | 含义 | 脱敏示例 | 示例数量 |
|---|---|---|---|
| ` - updating ` | 本地已有该文件，更新到新版本 | `//Example_Depot/.../ExampleAnimation.uasset#3 - updating D:\ExampleDepot\...\ExampleAnimation.uasset` | 5072 |
| ` - added as ` | 本地没有的新文件 | `//Example_Depot/.../ExampleAudio_...uasset#1 - added as D:\ExampleDepot\...\SFX_...uasset` | 3001 |
| ` - deleted as ` | 该文件被删除 | `//Example_Depot/.../ExampleSound.uasset#1 - deleted as D:\ExampleDepot\...\...uasset` | 523 |
...
> 真实形态（§1a 的每文件行现在长这样）：
> ```
> info: //Example_Depot/.../X.uasset#1 - added as D:\ExampleDepot\...\X.uasset
> info: //Example_Depot/.../Y.uasset#3 - updating D:\ExampleDepot\...\Y.uasset
> exit: 0
> ```
>
...
| 行 | 含义 |
|---|---|
| `<path> - no such file(s).` | 该路径在 server 没有文件（如 `UnrealEngine/ExampleGame/DerivedDataCache/... - no such file(s).`，DerivedDataCache 常见） |
