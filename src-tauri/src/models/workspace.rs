...
mod tests {
    ...
    fn debug_does_not_leak_identity() {
        ...
        assert!(
            !dbg.contains("alice-laptop-examplegame"),
    ...
    fn workspace_config_serializes_camelcase_keys() {
        ...
        let cfg = WorkspaceConfig {
            ...
            p4_client: "bravo-laptop-examplegame".to_string(),
    ...
    fn workspace_config_deserializes_legacy_snake_case_keys() {
        ...
        let legacy_json = r#"{
            ...
            "root_path": "E:\\proj",
            "projectDir": "MyGame",
            "p4_client": "bravo-laptop-examplegame",
            "p4_user": "bravo",
            "last_sync_cl": "123456",
        ...
        assert_eq!(cfg.p4_client, "bravo-laptop-examplegame");
